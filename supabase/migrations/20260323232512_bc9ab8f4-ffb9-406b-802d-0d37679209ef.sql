...
-- Update validation trigger with new allowed values
...
UPDATE fomento_projects SET natureza = NULL WHERE natureza IN ('outorga','parceria');
UPDATE fomento_projects SET vinculo_academico = NULL WHERE vinculo_academico = 'ambos';
